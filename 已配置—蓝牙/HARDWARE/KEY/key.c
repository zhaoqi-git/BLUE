...
{ 
	...
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_12|GPIO_Pin_11|GPIO_Pin_13|GPIO_Pin_9;//KEY0-KEY2
...
{	 
	...
	if(key_up||(KEY0==1&&KEY1==1&&KEY2==1&&WK_UP==0))
	{
		delay_ms(50);//去抖动 
		key_up=1;
	...
	}else if(KEY0==0||KEY1==0||KEY2==0||WK_UP==1)key_up=0; 	    
 	return 0;// 无按键按下
}
