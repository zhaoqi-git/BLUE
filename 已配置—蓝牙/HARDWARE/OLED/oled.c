...
{ 	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3|GPIO_Pin_6|GPIO_Pin_5|GPIO_Pin_4|GPIO_Pin_2;	 //PD3,PD6推挽输出  
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	GPIO_Init(GPIOE, &GPIO_InitStructure);	  //初始化GPIOD3,6
// 	GPIO_SetBits(GPIOE,GPIO_Pin_3|GPIO_Pin_6|GPIO_Pin_5|GPIO_Pin_4|GPIO_Pin_2);	//PD3,PD6 输出高	 
...
*  函数名称：OLED_DrawPoint
*  功能说明：画点函数
*  参数说明：x:0~127  y:0~63  t:1 填充 0,清空	
*  修改时间：2016-08-29   已测试
*  
*************************************************************************/
...
*
*  函数名称：OLED_DrawPoint
*  功能说明：x1,y1,x2,y2 填充区域的对角坐标
*  参数说明：x:0~127  y:0~63  t:1 填充 0,清空	确保x1<=x2;y1<=y2 0<=x1<=127 0<=y1<=63
*  修改时间：2016-08-29   已测试
*  
*************************************************************************/
...
*  参数说明：x:0~127  y:0~63   size:选择字体 12/16/24   mode:0,反白显示;1,正常显示	
*  修改时间：2016-08-29   已测试
*  
*************************************************************************/
...
*  函数名称：OLED_ShowNum
*  功能说明：显示2个数字
*  参数说明：x:0~127  y:0~63  num:数值(0~4294967295) len :数字的位数   0,填充模式;1,叠加模式  	size:字体大小
*  修改时间：2016-08-29   已测试
*  
*************************************************************************/
...
*  功能说明：显示字符串
*  参数说明：起始点坐标(x,y),x的范围0～127，y为页的范围0～63，*p:字符串起始地址， size:字体大小（12,16,24），
*  修改时间：2016-08-29   修改备注 已测试
*  
*************************************************************************/
...
/*************************************************************************
*
*  函数名称：void Draw_BMP(uint8_t x,uint8_t y)
*  功能说明：显示BMP图片
*  参数说明：起始点坐标(x,y),x的范围0～127，y为页的范围0～7
*  函数返回：无
*  修改时间：2012-12-12   修改备注 已测试
*  
*************************************************************************/
...
//在指定位置，显示一个汉字
//x,y :汉字的坐标
//fnum:汉字编号（在字库数组里面的编号） ，size:字体大小（10,16）
